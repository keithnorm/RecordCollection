    ...
    switch(gestureRecognizer.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            if (_editModeOn) {
                ...
                if ([self.delegate respondsToSelector:@selector(shouldEnableEditingForCollectionView:layout:)]) {
                    BOOL shouldEnableEditing = [self.delegate shouldEnableEditingForCollectionView:self.collectionView layout:self];
            ...
            collectionViewCell.contentView.hidden = YES;
...
//                                             collectionViewCell.contentView.alpha = 1.0f; // added by kn
                                             collectionViewCell.contentView.hidden = NO;
                                             [strongSelf.delegate collectionView: strongSelf.collectionView
                                                                          layout: strongSelf
